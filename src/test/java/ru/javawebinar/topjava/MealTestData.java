...
public class MealTestData {
    ...
    public static final Meal meal4 = new Meal(MEAL_ID + 3, LocalDateTime.of(2020, Month.JANUARY, 31, 20, 0), "Еда на граничное значение", 100);
...
//    public static final Meal MEAL_2_ADMIN = new Meal(MEAL_ADMIN_ID + 1, LocalDateTime.of(2020, Month.JANUARY, 30, 10, 0), "Завтрак", 500);
    ...
    private static final Comparator<LocalDateTime> truncateSeconds = (a, exp) ->
